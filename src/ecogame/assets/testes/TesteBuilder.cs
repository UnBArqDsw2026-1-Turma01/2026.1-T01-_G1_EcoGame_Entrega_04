...
public partial class TesteBuilder : Node
{
    public override void _Ready()
    {
        ...
        regadorBuilder.AdicionarIngrediente(new Reciclado("Bloco de Metal", 1, MaterialBase.METAL));
        regadorBuilder.AdicionarIngrediente(new Reciclado("Bloco de Plástico", 2, MaterialBase.GARRAFA_PET));
        ...
        var balde = new BaldeComposite("Balde", 1, MaterialBase.GARRAFA_PET, 5);
