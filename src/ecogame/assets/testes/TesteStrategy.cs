...
public partial class TesteStrategy : Node
{
    public override void _Ready()
    {
        ...
        baldeBuilder.AdicionarIngrediente(new Reciclado("Bloco de Metal", 2, MaterialBase.METAL));
        baldeBuilder.AdicionarIngrediente(new Reciclado("Bloco de Plástico", 1, MaterialBase.GARRAFA_PET));
